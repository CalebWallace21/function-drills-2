...
// CODE HERE
const totalPopulation  = populations.reduce((accum, cval) => accum + cval)
...
const totalPrice = orders.map(function(num){
...
const bobTotal = purchases.filter(name => name.owner === `Bob`).reduce((acc, curr) => acc + curr.price, 0)
